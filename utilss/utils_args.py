...
def get_args_base():
    ...
    parser.add_argument(
        '--dalle_path',
        type=str,
        default='./dalle_path/vox_bert_text_bs48_100k.pt',
        help=
    ...
    parser.add_argument(
        ...
        help=
        'experiment name, training logs are stored in log_dir=log_log_root/name')
    ...
    parser.add_argument("--solo_output",
                        type=str,
                        default='output',
                        help='root directory for solo_image')
    ...
    parser.add_argument(
        ...
        default=None,
        help=
        'specify a pretrained language model to use for text augmentation, e.g. roberta-large'
    )
    ...
    parser.add_argument('--num_workers', default=1, type=int)  #, default=16
    parser.add_argument(
        '--text_emb_bottleneck',
        type=str,
        default=None,
...
def get_args_train():
    ...
    parser.add_argument('--gpu_ids',
                        ...
                        default=None,
                        help='gpu id to use')
    parser.add_argument('--workers',    # max = 10
    ...
    parser.add_argument('--lr_scheduler_warmup',    # WarmupLR 学习率衰减策略
                        default=5000, # iters=200000, lr_scheduler_warmup=5000   50000-1500
                        type=int,
    ...
    parser.add_argument('--beta_dis',
                        default=0.7,
                        type=float,
                        help='weight for Dis loss')
    parser.add_argument(
        '--msm_strategy_prob',
        type=str,
        default='7,1,1,1',
...
def process_args(train=False):
    ...
    if train:
        ...
        args.vae_path = "./pretrained_models/vae_vox.ckpt"
